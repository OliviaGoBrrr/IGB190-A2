	...
	SubShader {
		...
		Pass {
			...
			v2f vert(a2v v) {
				...
				o.coord0.xy = (wPos.yz - _MainTex_ST.zw) * _MainTex_ST.xy;
				o.coord0.zw = (wPos.xz - _MainTex_ST.zw) * _MainTex_ST.xy;
				o.coord1.xy = (wPos.xy - _MainTex_ST.zw) * _MainTex_ST.xy;
