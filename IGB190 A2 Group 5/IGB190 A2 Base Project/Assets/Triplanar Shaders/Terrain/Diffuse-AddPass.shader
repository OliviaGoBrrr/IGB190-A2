...
Shader "Triplanar/Terrain/Diffuse-AddPass" {
	Properties {
	...
	SubShader {
		...
		CGPROGRAM
		#pragma target 3.0
		#pragma surface surf Lambert decal:add vertex:vert finalcolor:myfinal exclude_path:prepass exclude_path:deferred
